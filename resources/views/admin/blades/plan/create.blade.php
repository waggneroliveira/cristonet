                        ...
                        <div class="col-12 col-lg-6">
                            <div class="row">
                                <div class="mb-3 col-6 d-flex align-items-start flex-column">
                                    ...
                                    <select name="plan_category_id" class="form-select" id="category-select" required>
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input name="active" type="checkbox" class="form-check-input" id="invalidCheck{{isset($plan->id)?$plan->id:''}}" />
                                ...
                                <div class="form-check">
                                    <input name="super_highlight" {{ isset($plan->super_highlight) && $plan->super_highlight == 1 ? 'checked' : '' }} type="checkbox" class="form-check-input" id="invalidCheck2{{isset($plan->id)?$plan->id:''}}" />
                                    <label class="form-check-label" for="invalidCheck2{{isset($plan->id)?$plan->id:''}}">Super destaque?</label>
                                    <div class="invalid-feedback">
                                        You must agree before submitting.
                                    </div>
                                </div>
                                <div class="form-check">
                                    <input name="highlight" {{ isset($plan->highlight) && $plan->highlight == 1 ? 'checked' : '' }} type="checkbox" class="form-check-input" id="invalidCheck3{{isset($plan->id)?$plan->id:''}}" />
                                    <label class="form-check-label" for="invalidCheck3{{isset($plan->id)?$plan->id:''}}">Destaque?</label>
                                    <div class="invalid-feedback">
                                        You must agree before submitting.
                                    </div>
                                </div>
...
<script>
    ...
    CKEDITOR.replace('textarea-create', {
        ...
        filebrowserUploadUrl: "{{ route('admin.dashboard.plan.uploadImageCkeditor') }}",
