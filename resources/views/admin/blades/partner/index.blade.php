                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-6">
                                    @if(Auth::user()->hasRole('Super') || Auth::user()->can('usuario.tornar usuario master') || Auth::user()->can(['parceiros.visualizar', 'parceiros.remover']))
                                ...
                                <div class="col-6 d-flex justify-between">
                                    <div class="col-12 d-flex justify-content-end">
                                        @if (isset($partners) && $partners->count() < 6)                                            
                                            @if (Auth::user()->hasRole('Super') || Auth::user()->can('usuario.tornar usuario master') || Auth::user()->can(['parceiros.visualizar', 'parceiros.criar']))
                                        ...
                                        @foreach ($partners as $key => $partner)                                            
                                            <tr data-code="{{$partner->id}}">
                                                ...
                                                <td class="d-flex gap-lg-1 justify-center" style="padding: 18px 15px 0px 0px;">
                                                    @if (Auth::user()->hasRole('Super') || Auth::user()->can('usuario.tornar usuario master') || Auth::user()->can(['parceiros.visualizar', 'parceiros.editar'])) 
